...
export const APP_ROUTES: Routes = [
  ...
  { path: 'kitchen-login', loadComponent: () => import('./pages/kitchen-login/kitchen-login.component').then(m => m.KitchenLoginComponent) },
  { path: 'kitchen/select-branch', loadComponent: () => import('./pages/kitchen-select-branch/kitchen-select-branch.component').then(m => m.KitchenSelectBranchComponent) },
